...
{
    public class DeleteProdutoCommand : AbstractCommand<ResultProduto>
    {
        ...
        public DeleteProdutoCommand(IRepository<Produto, int, ProdutoFilter> Repository, ProdutoModel Model)
        {
        ...
        {
            _repository.Delete(_model.ProdutoId);
